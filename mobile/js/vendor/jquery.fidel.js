...
jQuery.fn.fidel = function(o){
	...
	return this.each(function() {
		...
		var chb;
		var op;
		var inf = $('<div style="display:none;position:fixed;bottom:0;left:0;z-index:1100;width:160px;height:10px;padding:2px 5px 8px 40px;background:#F2F2F2;/*border:1px solid gray;*/border-radius:0 6px 0 0;color:#000;font-size:12px;"></div>');
		var inpt = $('<div class="show_prototype" style="position:fixed;top:13px;left:12px;z-index:1100;width:13px;height:13px;background:#5C99D6;border:1px solid #345073; border-radius:6px;cursor:pointer;opacity:0.3;"></div>');
		var chb = $('<div class="show_infobox" style="position:fixed;top:31px;left:12px;z-index:1100;width:13px;height:13px;background:#5C99D6;border:1px solid #345073; border-radius:6px;cursor:pointer;opacity:0.3;"></div>');
		var op = $('<div class="opacity" style="position:fixed;top:13px;left:30px;z-index:1100;width:13px;height:13px;background:#5C99D6;border:1px solid #345073; border-radius:6px;cursor:pointer;opacity:0.3;"></div>');
		var under = $('<div class="under" style="position:fixed;top:31px;left:30px;z-index:1100;width:13px;height:13px;background:#5C99D6;border:1px solid #345073; border-radius:6px;cursor:pointer;opacity:0.3;"></div>');
